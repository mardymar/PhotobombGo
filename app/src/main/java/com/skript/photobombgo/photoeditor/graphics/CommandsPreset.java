...
import com.skript.photobombgo.photoeditor.graphics.commands.BlackFrameCommand;
import com.skript.photobombgo.photoeditor.graphics.commands.ColorFilterCommand;
import com.skript.photobombgo.photoeditor.graphics.commands.EmbossCommand;
import com.skript.photobombgo.photoeditor.graphics.commands.EmptyCommand;
import com.skript.photobombgo.photoeditor.graphics.commands.GammaCorrectionCommand;
import com.skript.photobombgo.photoeditor.graphics.commands.GaussianBlurCommand;
import com.skript.photobombgo.photoeditor.graphics.commands.GrayscaleCommand;
import com.skript.photobombgo.photoeditor.graphics.commands.ImageProcessingCommand;
import com.skript.photobombgo.photoeditor.graphics.commands.InvertColorCommand;
import com.skript.photobombgo.photoeditor.graphics.commands.MirrorCommand;
import com.skript.photobombgo.photoeditor.graphics.commands.SepiaCommand;
import com.skript.photobombgo.photoeditor.graphics.commands.SharpenCommand;
