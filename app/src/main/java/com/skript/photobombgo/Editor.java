...
import com.skript.photobombgo.multitouch.MultiTouchListener;
import com.skript.photobombgo.permissions.PermissionUtil;
...
public class Editor extends AppCompatActivity implements View.OnClickListener {
    ...
    private final String DIR_SAVE="Photobomb Go";
    ...
    private void startTattooActivity() {
        ...
        ip.setBitmap(bitmap);
        ip.setImageMatrix(imageView.getImageMatrix());
        ip.setViewMatrix(imageView.getMatrix());
        ip.setRect(imageView.getDrawable().getBounds());
    ...
    private void initSave(){
        ...
        PermissionUtil.checkPermission(mActivity, Manifest.permission.WRITE_EXTERNAL_STORAGE,
